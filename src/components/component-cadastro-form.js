...
function CadastroForm() {
	return (
		<>
			...
			<form>
					<input type={'text'} className={forms.input_form} placeholder={'E-mail'} />
					<input type={'text'} className={forms.input_form} placeholder={'Repita seu E-mail'} />
					<input type={'password'} className={forms.input_form} placeholder={'Senha'} />
					<input type={'password'} className={forms.input_form} placeholder={'Confirme sua Senha'} />

					<label htmlFor='aceite' className={forms.checkbox_label}>
						<input type={'checkbox'} id='aceite' /> Eu aceito os termos e condições.
					</label>
